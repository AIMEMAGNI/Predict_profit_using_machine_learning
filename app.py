...
if selected == "Project":
    ...
    st.warning('This dataset only shows the expenditures and profit from an unkown company. It does not show their investiments or capital. However it was used to showcase how Machine Learning model would help in profit prediction, because Machine Learning model uses the similar approach for prediction.')
