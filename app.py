...
if selected == "Project":
    ...
    st.warning('This dataset only shows the expenditures and profit from an unkown company. It does not show their investiments or capital. However it was used to showcase how Machine Learning model would handle the task because it uses the similar approach to solve the problem.')
